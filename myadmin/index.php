<?php
session_start();
include_once "mysqli_koneksi.php";
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>Admin GhiNaj Shop | GS </title>
  ...
  <section id="container" class="">
	...
	if(isset($_REQUEST["page"])) {
		switch($_REQUEST["page"]){
            ...
            case "order" : include("display_order.php");break;
            ...
            case "input_order" : include("input_order.php");break;
			case "edit_order" : include("edit_order.php");break;
            case "delete_order" : include("delete_order.php");break;
