...
//insert ke tabel
$query = "INSERT INTO produk(nm_prdk,hrg_prdk,stok,gmbr,id_ktgri) VALUES('$nama','$harga','$stok','$gambar','$kategori')";
...
<div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-laptop"></i>Input Order</li>						  	
					</ol>
				</div>
			</div>
