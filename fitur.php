...
<html lang="en">
  <head>
    <title>GhiNaj Shop &mdash; Fitur Lain</title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
          ...
          <div class="main-nav d-none d-lg-block">
              <nav class="site-navigation text-right text-md-center" role="navigation">
                <ul class="site-menu js-clone-nav d-none d-lg-block">
                  ...
                  <li class="active"><a href="fitur.php">Fitur Lain</a></li>
                </ul>
              </nav>
            </div>
    ...
    <div class="site-blocks-cover inner-page" style="background-image: url('images/hero_2.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center" data-aos="fade">
      ...
      <div class="custom-border-bottom py-3">
        <div class="container">
          <div class="row">
            <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Fitur</strong></div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
            ...
            <tr>
                <td width="70px">
                    <img src="images/instagram.jpg" height="50px" width="50px">
                </td>
                <td>
                    <p> 
                        @ghinaj.shop &nbsp &nbsp &nbsp
                    </p> 
                </td>
                ...
                <td width="70px">
                    <img src="images/line.png" height="50px" width="50px">
                </td>
                <td>
                    <p> 
                        @ghinaj.shop &nbsp &nbsp &nbsp
                ...
                <td width="70px">
                <img src="images/login.png" height="50px" width="50px">
              </td>

              <td>
                <a href="myadmin/login.php"><i class="glyphicon glyphicon-submit"></i>Login Admin</a>
              </td>
