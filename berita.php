...
<html lang="en">
  <head>
    <title>GhiNaj Shop &mdash; Berita</title>
    <meta charset="utf-8">
    ...
    <?php
                ...
                while($hasil = mysqli_fetch_array($query)){ 
                    ...
                    <div class="">
                        ...
                        <img src="<?php echo $hasil['gambar']; ?>" alt="Image" class="img-fluid" width="200px" height="200px" >
                      
                      <h2 class="item-title"><a href="<?php echo $hasil['link']; ?>"><?php echo $hasil['judul']; ?></a></h2>
