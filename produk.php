          ...
          <div class="main-nav d-none d-lg-block">
            <nav class="site-navigation text-right text-md-center" role="navigation">
              <ul class="site-menu js-clone-nav d-none d-lg-block">
                ...
                <li class="active"><a href="produk.php">Kelola Produk</a></li c>
    ...
    <div class="container">
        <div class="row">
          <div class="title-section mb-5 col-12">
            <h2 class="text-uppercase">KELOLA PRODUK</h2>
          </div>

          <div class="panel panel-default">
            <div class="panel-heading"> <center> <h3>Kelola Produk</h3></center></div></div>
            <table  width="70%" border="10" cellspacing="100" cellpadding="100" class="table table-bordered">
             <tr>
                <th align="right" scope="col">Kategori</th>
                 ...
                 <th align="right" scope="col">Stok</th>
             </tr>
                     <tr>
                         <td>Wanita</td>
