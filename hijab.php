...
<html lang="en">
  <head>
    <title>GhiNaj Shop &mdash; Hijab</title>
    <meta charset="utf-8">
          ...
          <div class="main-nav d-none d-lg-block">
              <nav class="site-navigation text-right text-md-center" role="navigation">
                <ul class="site-menu js-clone-nav d-none d-lg-block">
                  ...
                  <li class="active"><a href="hijab.php">Hijab</a></li>
    ...
    <div class="container">
            <div class="row">
              <div class="title-section mb-5 col-12">
                <h2 class="text-uppercase">Hijab</h2>
              </div>
            </div>
            <div class="row">

            <?php
                $query = mysqli_query($koneksi,"SELECT * FROM produk WHERE id_kategori IN('4')");
                while($hasil = mysqli_fetch_array($query)){ 
                    ...
                    <div class="col-lg-4 col-md-6 item-entry mb-4">
                      ...
                      <a href="cart.php?act=add&amp;id_produk=<?php echo $query_row['id_produk'];?>&amp;ref=hijab.php" class="btn btn-s btn-primary">
